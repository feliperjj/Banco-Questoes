...
class GeradorProvaPage(QWidget):
    def __init__(self):
        ...
        subtitulo = QLabel("Monte uma prova aleatória com questões do seu banco.")
        ...
        form.addWidget(self._label("Banca"), 2, 2)
        form.addWidget(self.banca_input, 2, 3)

        self.topico_input = QComboBox()
        self.topico_input.addItem("Todas as categorias")
        self.topico_input.addItems(repo.listar_topicos())
        form.addWidget(self._label("Categoria"), 3, 0)
        form.addWidget(self.topico_input, 3, 1)
        ...
        form.addWidget(self._label("Tipo de questão"), 3, 2)
        form.addWidget(self.tipo_input, 3, 3)

        self.qtd_input = QSpinBox()
        self.qtd_input.setRange(1, 200)
        self.qtd_input.setValue(10)
        self.qtd_input.setSuffix(" questões")
        form.addWidget(self._label("Quantidade"), 4, 0)
        form.addWidget(self.qtd_input, 4, 1)
        ...
        form.addWidget(self._label("Tempo limite"), 4, 2)
        form.addWidget(self.tempo_input, 4, 3)
        ...
        form.addWidget(self.lbl_disponiveis, 5, 0, 1, 3)
